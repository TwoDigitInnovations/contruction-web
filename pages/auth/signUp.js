  ...
  return (
    <div>
      <div className="relative bg-[url('/Image/construction.jpg')] bg-cover bg-center h-[1000px] w-full">
        ...
        <div className="absolute inset-0 flex md:flex-col justify-center items-center z-10">
            ...
            <div className="">
              <div className="border bg-gray-700 border-gray-500 rounded px-5 sm:px-8 md:px-10 lg:px-12 py-8 md:py-10 lg:py-12 w-[90%] md:w-[450px] lg:w-[500px] mx-auto">
                ...
                <div className="pt-5">
                  ...
                  <input
                    className={`w-full px-3 py-3 rounded text-custom-black ${errors.username ? 'border-2 border-red-500' : ''
                      }`}
                    type="text"
                ...
                <div className="pt-5">
                  ...
                  <input
                    className={`w-full px-3 py-3 rounded text-custom-black ${errors.email ? 'border-2 border-red-500' : ''
                      }`}
                    type="email"
                ...
                <div className="pt-5">
                  ...
                  <input
                    className={`w-full px-3 py-3 rounded text-custom-black ${errors.phone ? 'border-2 border-red-500' : ''
                      }`}
                    type="tel"
                ...
                <div className="pt-5 pb-5">
                  ...
                  <input
                    className={`w-full text-custom-black py-3 px-3 rounded ${errors.password ? 'border-2 border-red-500' : ''
                      }`}
                    type="password"
                    placeholder="***************"
