...
function Updatepassword(props) {
    ...
    const Submit = (e) => {
        ...
        if (oldPassword === "") {
            props.toaster({ type: "error", message: "Old Password is required" });
            return;
        }
        if (newPassword === "") {
        ...
        if (confirmNewPassword === "") {
            props.toaster({ type: "error", message: "Confirm New Password is required" });
            return;
        }
        ...
        if (confirmNewPassword !== newPassword) {
            props.toaster({
                type: "error",
                message: "Your new password is not matched with confirm password",
            });
            return;
        }
        ...
        props.loader(true);
        Api("post", "updatepassword", data, router).then(
            (res) => {
                console.log("res================>", res);
                props.loader(false);
